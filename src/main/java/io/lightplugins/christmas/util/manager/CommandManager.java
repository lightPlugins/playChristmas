...
import io.lightplugins.christmas.util.CompositeTabCompleter;
                            ...
                            if(player.hasPermission(subCommand.getPermission())) {
                                if(args.length != subCommand.maxArgs()) {
                                    LightMaster.instance.getMessageSender().sendPlayerMessage(
                                            LightAdventCalendar.instance.getMessageParams().wrongSyntax()
                                ...
                                LightMaster.instance.getMessageSender().sendPlayerMessage(
                                        LightAdventCalendar.instance.getMessageParams().noPermission()
